...
import com.moneyroomba.service.InvoiceQueryService;
import com.moneyroomba.service.InvoiceService;
...
/**
 * REST controller for managing {@link com.moneyroomba.domain.Invoice}.
 */
@RestController
@RequestMapping("/api")
public class InvoiceResource {
     ...
     */
    @GetMapping("/invoices")
    public ResponseEntity<List<Invoice>> getAllInvoices(InvoiceCriteria criteria) {
        log.debug("REST request to get Invoices by criteria: {}", criteria);
        List<Invoice> entityList = invoiceQueryService.findByCriteria(criteria);
