...
import com.moneyroomba.service.IconQueryService;
import com.moneyroomba.service.IconService;
...
/**
 * REST controller for managing {@link com.moneyroomba.domain.Icon}.
 */
@RestController
@RequestMapping("/api")
public class IconResource {
     ...
     */
    @PutMapping("/icons/{id}")
    public ResponseEntity<Icon> updateIcon(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody Icon icon)
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/icons/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<Icon> partialUpdateIcon(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody Icon icon
    ) throws URISyntaxException {
     ...
     */
    @GetMapping("/icons")
    public ResponseEntity<List<Icon>> getAllIcons(IconCriteria criteria) {
        log.debug("REST request to get Icons by criteria: {}", criteria);
        List<Icon> entityList = iconQueryService.findByCriteria(criteria);
