...
import { ChartComponent, ApexAxisChartSeries, ApexChart, ApexYAxis, ApexXAxis, ApexFill, ApexGrid, ApexMarkers } from 'ng-apexcharts';
  ...
  constructor() {
    this.chartOptions = {
      ...
      fill: {
        ...
        opacity: 1,
        image: {
          src: ['https://freesvg.org/img/Simple-Water-Icon.png', 'assets/images/charts/fb.png'],
          width: 40,
          height: 40,
        },
      },
