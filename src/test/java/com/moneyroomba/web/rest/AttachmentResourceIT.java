...
import com.moneyroomba.repository.AttachmentRepository;
...
class AttachmentResourceIT {
    ...
    public static Attachment createEntity(EntityManager em) {
        Attachment attachment = new Attachment().url(DEFAULT_URL).name(DEFAULT_NAME);
        return attachment;
    }
    ...
    public static Attachment createUpdatedEntity(EntityManager em) {
        Attachment attachment = new Attachment().url(UPDATED_URL).name(UPDATED_NAME);
        return attachment;
    }
    ...
    void putNewAttachment() throws Exception {
        ...
        updatedAttachment.url(UPDATED_URL).name(UPDATED_NAME);
    ...
    void fullUpdateAttachmentWithPatch() throws Exception {
        ...
        partialUpdatedAttachment.url(UPDATED_URL).name(UPDATED_NAME);
